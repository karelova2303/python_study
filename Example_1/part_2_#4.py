# Задача 4
#  Нарисовать изображение кота

#  Импортировать необходимые фигуры рисования, подключить  модуль для рисования:
...
# Создать область, связанную с осями координат, куда будут выводиться плоские фигуры (ax), вызвать функцию рисования
ax = plt.gca()
draw_cat(ax)
